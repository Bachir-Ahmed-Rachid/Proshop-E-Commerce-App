...
export const ORDER_DILEVER_REQUEST = 'ORDER_DILEVER_REQUEST'
export const ORDER_DILEVER_SUCCESS='ORDER_DILEVER_SUCCESS'
export const ORDER_DILEVER_FAIL='ORDER_DILEVER_FAIL'
export const ORDER_DILEVER_RESET="ORDER_DILEVER_RESET"