import {PRODUCT_LIST_REQUEST,
  ...
  PRODUCT_CREATE_FAIL,
  PRODUCT_CREATE_RESETE,
  PRODUCT_UPDATE_REQUEST,
  PRODUCT_UPDATE_SUCCESS,
  PRODUCT_UPDATE_FAIL,
  PRODUCT_UPDATE_RESETE,
  PRODUCT_CREAT_REVIEW_REQUEST,
  PRODUCT_CREAT_REVIEW_SUCCESS,
  PRODUCT_CREAT_REVIEW_FAIL,
  PRODUCT_TOP_REQUEST,
  PRODUCT_TOP_SUCCESS,
  PRODUCT_TOP_FAIL,
  PRODUCT_CREAT_REVIEW_RESETE,
...
export const productCreateReducer=(state={},action)=>{
  switch(action.type){
   ...
   case PRODUCT_CREATE_RESETE : return{}
...
export const productUpdateReducer=(state={product:{}},action)=>{
  switch(action.type){
   ...
   case PRODUCT_UPDATE_RESETE : return{product:{}}
...
export const productCreatReviewReducer=(state={},action)=>{
  switch(action.type){
   case PRODUCT_CREAT_REVIEW_REQUEST : return{loading:true}
   case PRODUCT_CREAT_REVIEW_SUCCESS : return{loading:false,success:true}
   case PRODUCT_CREAT_REVIEW_FAIL : return{loading:false,error:action.payload}
   case PRODUCT_CREAT_REVIEW_RESETE : return{}
