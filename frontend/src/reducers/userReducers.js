...
export const userProfileUpdatesReducer=(state={},action)=>{
  switch(action.type){
   case USER_UPDATE_PROFIL_REQUEST : return{loading:true}
   case USER_UPDATE_PROFIL_SUCCESS : return{loading:false,success:true,user:action.payload}
   case USER_UPDATE_PROFIL_FAIL : return{loading:false,error:action.payload}
...
export const userListReducer=(state={usersList:[]},action)=>{
  switch(action.type){
   ...
   case USER_LIST_SUCCESS : return{loading:false,usersList:action.payload}
   case USER_LIST_FAIL : return{loading:false,error:action.payload}
   case USER_LIST_RESET : return{usersList:[]}
...
export const userDeleteReducer=(state={usersList:[]},action)=>{
  switch(action.type){
